...
# It should be launch inside the docker container that is compatible with Gaussian Opacity Fields.
"""
...
CHANGE_WEATHER_BUTTON = 0
CHANGE_VEHICLE_BUTTON = 1
TOGGLE_AUTOPILOT_BUTTON = 2
TOGGLE_LIDAR_BUTTON = 9
EXIT_BUTTON = 7
START_RECORD_BUTTON = 6
...
class World(object):
    ...
    def render(self, display):
        ...
        self.camera_manager.render(display, small=True)
    ...
    def check_near_collision(self, world : World):
        for col in range(800,1200):
            for row in range(32,128):
                #TODO pass value to meter (50m = 2^16)
                if world.lidar_sensor.range_image[col,row]*1000.0<NEAR_COLLISION_DISTANCE:
            ...
            if event.type == pygame.JOYDEVICEADDED:
                ...
                if event.button == CHANGE_VEHICLE_BUTTON:
                    ...
                    if world.recording_enabled:
                        ...
                        world.video = cv2.VideoWriter("./videos/output"+str(video)+".avi", fourcc, 15, (world.args.width, world.args.height+128))
                        world.recording_enabled=True
                        self.hud.notification("Recording video.")
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            if world.recording_enabled: world.record_video()
            pygame.display.flip()
...
def main():
    ...
    argparser.add_argument(
        ...
        metavar='H',
        default='gof',
        help='Gaussian splatting model (gof, octreeGS or hierarchical3DGS) (default: gof)')
    argparser.add_argument(
        '--scene',
        metavar='H',
        default='scene1',
